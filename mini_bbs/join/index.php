...
// エラーをチェックする。
    ...
    if(empty($error)) {
        // メールの重複チェック
        $member = $db->prepare('SELECT COUNT(*) as cnt FROM membersm WHERE email = ?');
    ...
    if(empty($error)){
        ...
        move_uploaded_file($_FILES['image']['tmp_name'],'../member_picrure/' .$image);
...
<form action="" method="post" enctype="multipart/form-data">
    <dl>
        ...
        <dd>
            ...
            <p class="error">*画像ファイルは「.jpg」 「.gif」 「.png」 を選択してください</p>
            <?php
            endif;
            ?>
